        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">🌟 Our Vision
To create safer, smarter industries through autonomous robotics and IoT-driven innovation where technology protects people and powers progress.</div>
            {/* </div> */}
