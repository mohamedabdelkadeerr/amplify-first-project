    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          {/* Section header */}
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16 transform -translate-y-20">
            <h1 className="h1 mb-4" data-aos="fade-up">
              BOTBOT
            </h1>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
            Smart Autonomous Robots for Safer Industries
            </p>
          ...
          {/* Hero image */}
          <div>
          <div className="relative flex justify-center items-center transform -translate-y-8 transition-all duration-500" data-aos="fade-up" data-aos-delay="200">
              <img className="mx-auto relative flex justify-center items-center transform -translate-y-20 transition-all duration-500" src={HeroImage} width="1024" height="504" alt="Hero" />
              <a
                className="absolute group transform -translate-y-20"
                href="#0"
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
